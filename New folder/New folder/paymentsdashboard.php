...
if ($_SESSION['role'] !== '') {  // Corrected the role check to block non-admins
    die("Access denied!");
}
...
")->fetchAll(PDO::FETCH_ASSOC);  // Fetch results as associative array
...
if (isset($_GET['delete'])) {
    ...
    // Redirect to avoid re-submission of the delete request on page reload
    header('Location: payments_dashboard.php');
            ...
            <tbody>
                <?php foreach ($payments as $payment): ?>
                    <tr>
                        ...
                        <td>
                            <a href="payments_dashboard.php?delete=<?= htmlspecialchars($payment['id']) ?>" 
