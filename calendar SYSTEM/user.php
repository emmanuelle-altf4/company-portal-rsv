...
// Fetching all users
$users = $conn->query("SELECT * FROM users")->fetchAll(); // Make sure your users table name is correct
?>
...
<body>
    ...
    <button type="submit">Update Role</button>
        ...
        <table>
            <tr>
                <th>ID</th>
                <th>Admin Name</th> <!-- Changed from Username to Admin Name -->
                <th>Role</th>
            </tr>
            <?php foreach ($users as $user): ?>
            <tr>
                <td><?= htmlspecialchars($user['id']) ?></td>
                <td><?= htmlspecialchars($user['Fullname']) ?></td> <!-- Changed from Username to Admin Name -->
