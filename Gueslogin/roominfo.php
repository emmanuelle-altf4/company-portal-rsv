...
<!-- for ano to ung ifram burahin monalang if dili mo gusto -->
  ...
  <img src="room.jpg" alt="roominfo" class="item" onclick="window.location='roominfo.php'">
</div>
<h1>dasbdaskjdaskjdhadkjshdkjashdkjahdajkdhjadhasjkdhasjkdhasjkdhasdjkasdjkasndadnakda</h1>
